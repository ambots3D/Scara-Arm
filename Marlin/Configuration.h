...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80000/360,56320/360,2015.74803,500}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {900, 1200, 12, 900}    // (mm/sec)
