...
#define FEATURE_CONTROLLER 11      // 2 untuk smart controller LCD 2004, 11 untuk Reprap Graphic LCD, lihat wangsamas.h untuk LCD display lainnya
...
#define X_MIN_POS -30				// Posisi titik X minimum
#define Y_MIN_POS -90		// Posisi titik Y minimum
#define Z_MIN_POS 0					// Posisi titik Z minimum
#define XAXIS_STEPS_PER_UNIT 55.1	// Cartesian Steps/mm, Delta abaikan, Scara Steps/degree
#define YAXIS_STEPS_PER_UNIT 55.1		// Cartesian Steps/mm, Delta abaikan, Scara Steps/degree
#define ZAXIS_STEPS_PER_UNIT 200	// Cartesian Steps/mm, Delta Steps/mm, Scara Steps/mm

// Scara Setting
#define ARM_LENGTH 95					      // dalam mm. in mm
#define FOREARM_LENGTH 100			    	// dalam mm. in mm
#define SHOULDER_MIN_ANGLE 70		    	// dalam derajat. in degree
#define ELBOW_MIN_ANGLE 20				      // dalam derajat. in degree
#define SHOULDER_MAX_ANGLE 270			  // dalam derajat. in degree
#define ELBOW_MAX_ANGLE 290				    // dalam derajat. in degree
#define SHOULDER_BED_CENTER_ANGLE 131	// Posisi sudut bahu Scara di pusat papan dalam derajat. Position of Scara shoulder angle at bed center in degree
#define ELBOW_BED_CENTER_ANGLE 224 // Posisi sudut siku Scara di pusat papan dalam derajat. Position of Scara elbow angle at bed center in degree
