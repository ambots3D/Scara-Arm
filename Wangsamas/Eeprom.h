...
#define EPR_XAXIS_STEPS_PER_UNIT      3
#define EPR_YAXIS_STEPS_PER_UNIT      7
#define EPR_ZAXIS_STEPS_PER_UNIT     11
...
#define EPR_ARM_LENGTH 					1048 // Kusuma SCARA
#define EPR_FOREARM_LENGTH				1052 // Kusuma SCARA
#define EPR_SHOULDER_MIN_ANGLE			1056 // Kusuma SCARA
#define EPR_ELBOW_MIN_ANGLE				1060 // Kusuma SCARA
#define EPR_SHOULDER_MAX_ANGLE			1064 // Kusuma SCARA
#define EPR_ELBOW_MAX_ANGLE				1068 // Kusuma SCARA
#define EPR_SHOULDER_BED_CENTER_ANGLE 	1072 // Kusuma SCARA
#define EPR_ELBOW_BED_CENTER_ANGLE 		1076 // Kusuma SCARA
...
#define EPR_EXTRUDER_STEPS_PER_UNIT        0
...
public:
    ...
    static void storeScaraDataIntoEEPROM(uint8_t corrupted = 0); // Kusuma SCARA
...
#else															// Kusuma SCARA
        return ARM_LENGTH;										// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float forearmLength() {						// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_FOREARM_LENGTH);			// Kusuma SCARA
#else															// Kusuma SCARA
        return FOREARM_LENGTH;									// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float ShoulderMinAngle() {					// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_SHOULDER_MIN_ANGLE);		// Kusuma SCARA
#else															// Kusuma SCARA
        return SHOULDER_MIN_ANGLE;								// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float ElbowMinAngle() {						// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_ELBOW_MIN_ANGLE);			// Kusuma SCARA
#else															// Kusuma SCARA
        return ELBOW_MIN_ANGLE;									// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float ShoulderMaxAngle() {					// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_SHOULDER_MAX_ANGLE);		// Kusuma SCARA
#else															// Kusuma SCARA
        return SHOULDER_MAX_ANGLE;							// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float ElbowMaxAngle() {					// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_ELBOW_MAX_ANGLE);		// Kusuma SCARA
#else															// Kusuma SCARA
        return ELBOW_MAX_ANGLE;								// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float ShoulderBedCenterAngle() {				// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_SHOULDER_BED_CENTER_ANGLE);	// Kusuma SCARA
#else															// Kusuma SCARA
        return SHOULDER_BED_CENTER_ANGLE;						// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
    static inline float ElbowBedCenterAngle() {					// Kusuma SCARA
#if EEPROM_MODE != 0											// Kusuma SCARA
        return HAL::eprGetFloat(EPR_ELBOW_BED_CENTER_ANGLE);	// Kusuma SCARA
#else															// Kusuma SCARA
        return ELBOW_BED_CENTER_ANGLE;							// Kusuma SCARA
#endif															// Kusuma SCARA
	}															// Kusuma SCARA
#endif															// Kusuma SCARA
